...
import static org.seiko.panc.service.DownloadFlag.COMPLETED;
import static org.seiko.panc.service.DownloadFlag.FAILED;
import static org.seiko.panc.service.DownloadFlag.NORMAL;
import static org.seiko.panc.service.DownloadFlag.PAUSED;
import static org.seiko.panc.service.DownloadFlag.STARTED;
import static org.seiko.panc.service.DownloadFlag.WAITING;
...
class DownloadEventFactory {
    static DownloadEvent normal(DownloadStatus status) {
    ...
    private static DownloadEvent createEvent(int flag, DownloadStatus status) {
